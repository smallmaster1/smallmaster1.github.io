...
function showWelcome() {
  ...
  let dist = getDistance(123.41332, 41.76635, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
  ...
  else if (date.getHours() >= 11 && date.getHours() < 13) timeChange = "<span>中午好</span>，干饭啦，干饭啦。";
  else if (date.getHours() >= 13 && date.getHours() < 15) timeChange = "<span>下午好</span>，懒懒地睡个午觉吧！";
  else if (date.getHours() >= 15 && date.getHours() < 16) timeChange = "<span>三点几啦</span>，摸鱼时刻！";
  else if (date.getHours() >= 16 && date.getHours() < 19) timeChange = "<span>夕阳无限好！</span>";
  else if (date.getHours() >= 19 && date.getHours() < 24) timeChange = "<span>晚上好</span>，夜生活嗨起来！";
  else timeChange = "夜深了，早点休息，注意头发。";
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Fomalhaut🥝 %c 你正在访问Zmh🥝の小家",
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://w.wallhaven.cc/full/y8/wallhaven-y8lqo7.jpg);
    --darkmode-bg:url(https://w.wallhaven.cc/full/j3/wallhaven-j3m8y5.png);
    --mobileday-bg: url(https://w.wallhaven.cc/full/p9/wallhaven-p9ozm9.jpg);
    --mobilenight-bg: url(https://w.wallhaven.cc/full/jx/wallhaven-jxep8y.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
